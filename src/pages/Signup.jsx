...
import { Mail, Lock, User, Eye, EyeOff, Brain, Check, X } from 'lucide-react';
            ...
            <div>
              ...
              {formData.password && (
                <div className="mt-2 space-y-1">
                  <PasswordRequirement met={passwordValidation.errors.minLength} text="At least 8 characters" />
                  <PasswordRequirement met={passwordValidation.errors.hasUpper} text="One uppercase letter" />
                  <PasswordRequirement met={passwordValidation.errors.hasLower} text="One lowercase letter" />
                  <PasswordRequirement met={passwordValidation.errors.hasNumber} text="One number" />
                  <PasswordRequirement met={passwordValidation.errors.hasSpecial} text="One special character" />
                </div>
              )}
            </div>
